        ...
        <div class=" mx-3 pb-5">
            <div class="container">
                <section class="mt-5 overview">
                    ...
                    ?>
                    <div class="mt-4">
                        <form action="/admin/manage/page/research/update/data" enctype="multipart/form-data" method="post" id="form-details">
                            <div class="card mb-5">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="card-body">
                                <form action="/admin/manage/page/research/update/banner" method="post" enctype="multipart/form-data">
                                                    ...
                                                    if(!empty($data['get_research_images'])) {
                                                        foreach($data['get_research_images'] as $value) {
                                                            echo '
                                                                <tr>
                                                                    <td>
                                                                        <img src="/assets/home/images/research/'.$value->filename.'" alt="">
                                                                    </td>
                                                                    <td>
                                                                        <form action="/admin/manage/page/research/delete/image" method="post">
                                                ...
                                                if(!empty($data['get_research_authors'])) {
                                                    foreach($data['get_research_authors'] as $value) {
                                                        echo '
                                                            <tr>
                                                                <td>
                                                                    <img src="/assets/home/images/authors/'.$value->image.'" alt="">
                                                                </td>
                                                                <td>'.$value->firstname.'</td>
                                                                <td>'.$value->lastname.'</td>
                                                                <td>
                                                                    <form action="/admin/manage/page/research/delete/author" method="post">
                                                                        <div class="d-flex gap-2">
                                                                            <button type="submit" class="btn btn-success" name="id" value="'.$value->id.'"><i class="bx bx-show" ></i> View</button>
                                                                            <button type="submit" class="btn btn-danger" name="id" value="'.$value->id.'"><i class="bx bxs-trash bx-tada" ></i> Delete</button>
                                                                        </div>
