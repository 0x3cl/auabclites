                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 mb-3">
                                            <div class="form-group">
                                                <input type="text" name="firstname" id="firstname" class="form-control" autocomplete="disabled" value="<?= $data["get_officers_by_id"][0]->first_name ?>" required>
                                                <label for="firstname">First Name</label>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6 mb-3">
                                            <div class="form-group">
                                                <input type="text" name="lastname" id="lastname" class="form-control" autocomplete="disabled" value="<?= $data["get_officers_by_id"][0]->last_name ?>" required>
                                                ...
                                                <select name="position" id="position" class="form-control">
                                                    ...
                                                    <?php
                                                        foreach($data['get_positions'] as $value) {
                                                            echo '<option value="'.$value->id.'" '.($value->id === $data["get_officers_by_id"][0]->position_id ? 'selected' : '') .'>'.ucwords($value->name).'</option>';
                                                        }
                                                    ?>
                                                </select>
                                            </div>
