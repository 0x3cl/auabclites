                        ...
                        <div class="card-body">
                            <div class="mt-4">
                                ...
                                <div class="actions d-flex justify-content-end mb-4">
                                    <a href="/admin/manage/users" class="btn btn-primary icon"><i class='bx bx-arrow-back'></i> Go Back</a>
                                </div>
                                <form action="/admin/manage/users/add" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                    ...
                                    <div class="action d-flex justify-content-end mt-3 w-100">
                                        <button class="btn btn-primary py-3"><i class='bx bxs-save' ></i> Save Changes</button>
                                    </div>
                                </form>
                            </div>
                        </div>
