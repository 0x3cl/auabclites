            ...
            <div class="container">
                <section class="mt-5 overview">
                    <div class="actions mt-5 d-flex justify-content-end">
                            <a href="/admin/manage/page/bulletin" class="btn btn-primary"><i class='bx bx-arrow-back' ></i> Go Back</a>
                    </div>
                    <?php 
                    ...
                    <div class="mt-4">
                        <div class="card mb-5">
                            ...
                            <div class="card-body">
                                <form action="/admin/manage/page/bulletin/update/<?= $fields_data->id ?>" enctype="multipart/form-data" method="post" id="form-details">
                                    <div class="row" id="news-form">
                                        <div class="col-12 col-md-12 mb-3">
                                            <div class="form-group">
                                                <input type="text" name="title" id="title" class="form-control" value="<?= format_timestamp_to_data($fields_data->date_created)  ?>" autocomplete="disabled" disabled>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-12 mb-3">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="card-body">
                                <div class="col-12 col-md-12 mb-3">
                                    <form action="/admin/manage/page/bulletin/update/banner/<?= $fields_data->id ?>" method="post" enctype="multipart/form-data" id="form-banner">
                                        <div class="d-flex gap-3 mt-3">
                                            <div class="user-content">
                                                <div class="avatar-image w-100">
                                                    <img src="/assets/home/images/bulletin/<?= $image_path . '/' . $fields_data->image ?>" alt="" srcset="">
                                                </div>
                                            </div>
                        ...
                        <?php 
                            if(isset($flashdata["isNews"]) && $flashdata["isNews"] === 'true' || ($fields_data->category) == 2) {
                                ...
                                <div class="card mb-5">
                                    ...
                                    <div class="card-body">
                                        <form action="/admin/manage/page/bulletin/image/add" method="post" enctype="multipart/form-data" id="form-add-image">
                                            <div class="col-12 col-md-12 mb-3">
                                                <div class="d-flex gap-3 mt-3">
                                                    <div class="dropbox d-flex justify-content-center align-items-center">
                                                        <input type="hidden" name="id" value="'.$fields_data->id.'">
                                ...
                                ';
                            ?>
                            <form action="/admin/manage/page/bulletin/image/delete" method="post" id="form-image">
