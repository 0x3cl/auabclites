                ...
                <section class="mt-">
                    <div class="mt-5">
                        ...
                        <div class="actions mb-4 d-flex justify-content-end">
                            <a href="/admin/manage/page/home" class="btn btn-primary"><i class='bx bx-arrow-back'></i> Go Back</a>
                        </div>
                        <form action="/admin/manage/page/home/logo/update" method="post" enctype="multipart/form-data">
                            <div class="row">
                                                ...
                                                <div class="d-flex gap-3 w-100">
                                                    <div class="user-content">
                                                        <div class="avatar-image">
                                                            <input type="hidden" name="id" value="<?= $data['get_home_images_by_id'][0]->id ?>">
                                                            <input type="hidden" name="target" value="logo">
                                                            <img src="/assets/home/images/logo/<?php echo $data["get_home_images_by_id"][0]->image ?>" alt="" srcset="">
                                                        </div>
                                                    </div>
